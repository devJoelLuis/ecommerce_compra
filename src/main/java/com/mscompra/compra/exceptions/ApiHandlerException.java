...
public class ApiHandlerException extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleValidationInternal(Exception ex, HttpHeaders headers,
        ...
        List<Problem.FieldsProblem> problemObjects = bindingResult.getAllErrors().stream()
                .map(objectError -> {
                    ...
                    return Problem.FieldsProblem.builder()
                            .name(name)
                            .userMessage(message)
                            .build();
                })
    ...
    public ResponseEntity<Object> handleNegocio(BusinessRoleException ex, WebRequest request) {
